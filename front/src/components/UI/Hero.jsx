...
const Hero = ({ title, subtitle, cta, ctaLink, ctaSecondary, ctaSecondaryLink }) => {
    return (
        <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden bg-cream-100">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                <motion.h1
                    ...
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-6 text-indigo-nocturno-800"
                >
                    {title}
                </motion.h1>
